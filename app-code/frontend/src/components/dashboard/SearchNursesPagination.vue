...
const totalPages = computed(() => allNurses.totalPages)
let currentPage = computed(() => allNurses.currentPage)
...
const getNextPage = () => {
  ...
  allNurses.page = nextPage.value
  allNurses.fetchSearchedNurses(nextPage.value, props.searchQuery)
}
