...
import { useAppointmentsNotificationsStore } from '../../stores/appointmentsNotifications.js';
...
const notificationsStore = useAppointmentsNotificationsStore();
            ...
            <div v-else class="max-h-64 overflow-y-auto"> <!-- Added max height and scrollable overflow -->
                <div v-for="notification in notifications" :key="notification.id" class="card-body z-10">
                    <div v-if="!notification.read_at">
                        <RouterLink to="/doctor-appointments" @click="readNotifications">
                            <div class="font-jakarta">
                                <i class="fa-solid fa-bell"></i>
                                New Appointment Reservasion! <br>{{ formatDate(notification.created_at) }}
                            </div>
                            <hr>
                        </RouterLink>
                    </div>
