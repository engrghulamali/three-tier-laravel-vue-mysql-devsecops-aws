...
const totalPages = computed(() => allBirthReports.totalPages);
let currentPage = computed(() => allBirthReports.currentPage);
...
const getNextPage = () => {
  ...
  allBirthReports.page = nextPage.value;
  allBirthReports.fetchSearchedBirthReports(nextPage.value, props.searchQuery);
};
