...
const totalPages = computed(() => allLaboratorists.totalPages)
let currentPage = computed(() => allLaboratorists.currentPage)
...
const getNextPage = () => {
  ...
  allLaboratorists.page = nextPage.value
  allLaboratorists.fetchSearchedLaboratorists(nextPage.value, props.searchQuery)
}
