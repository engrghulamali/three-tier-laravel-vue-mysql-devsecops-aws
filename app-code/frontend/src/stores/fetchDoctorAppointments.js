...
export const useFetchDoctorAppointments = defineStore({
    id: 'fetchDoctorAppointments',
    state: () => ({
        data: null,
        currentPage: null,
        itemsPerPage: null,
    ...
    actions: {
        async fetchDoctorAppointments(page) {
            try {
                const response = await axios.get('/fetch-doctor-appointments', {
                    params: { page }
                });
        ...
        async fetchSearchedDoctorAppointments(page, searchQuery) {
            try {
                const response = await axios.get('/fetch-searched-doctor-appointments', {
        ...
        async fetchDoctorAppointmentsByStatus(paymentStatus, page) {
            try {
                const response = await axios.get('/fetch-doctor-appointments-by-status', {
        ...
        async fetchDoctorAppointmentsCount() {
            try {
                const response = await axios.get('/count-doctor-appointments');
